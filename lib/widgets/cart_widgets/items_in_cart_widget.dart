                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Container(
                            padding: //EdgeInsets.only(right: sizeConstants.getWidth10() / 10, left: sizeConstants.getWidth10() / 10, bottom: 5),
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    ...
                                    context.read<CartBloc>().add(
                                        CartEvent.addToCartEvent(item: item));
                                  },
                                  child: const Icon(
                                    Icons.add,
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.currency_ruble,
                                  ...
                                  color: Colors.black),
                              BigText(
                                text: "${item.price * double.parse(itemCount)}",
                                color: Colors.black,
                              )
                            ],
                          ),
