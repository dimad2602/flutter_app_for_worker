      ...
      body: SingleChildScrollView(
        child: Column(
            ...
            children: [
              ...
              ListView.builder(
                shrinkWrap: true,
                itemCount: widget.order.items?.length ?? 0, //items1.length,
                  ...
                  return widget.order.items![index].isComplete
                      ? Padding(
                          ...
                          child: CompliteItemInOrderWidget(
                            items: widget.order.items![index],
                            waiter: true,
                          ),
                        )
                      : Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: BigText(
                                  text:
                                      "Note: widget.order.note", // TODO У ордера может бить общее поле note (не только у items)
                                  color: Colors.black,
                                  italics: true,
                                  maxLines: 2,
                                ),
